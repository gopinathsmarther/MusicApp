...
public class TopTrackAdapter extends RecyclerView.Adapter<TopTrackAdapter.MyViewHolder> {

    List<TopRecentModel> topRecentModelList;
    Context context;
    SessionManager sessionManager;
    SuggestedFragment suggestedFragment;
    public TopTrackAdapter(Context context, List<TopRecentModel> topRecentModelList,SuggestedFragment suggestedFragment) {
