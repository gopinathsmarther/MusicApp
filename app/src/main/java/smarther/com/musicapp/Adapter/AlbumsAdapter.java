...
public class AlbumsAdapter extends RecyclerView.Adapter<AlbumsAdapter.MyViewHolder> {
    ...
    public static List<AlbumModel> albumModelList;
    Context context;
    ...
    public AlbumsAdapter(Context context, List<AlbumModel> albumModelList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (sessionManager.getAlbumsGrid()==1) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.audio_authur.setText(albumModelList.get(position).getArtistName()+" . "+albumModelList.get(position).getSongCount()+" songs");
...
//                PopupMenu popup = new PopupMenu(wrapper, view);
                ...
                popup.getMenuInflater().inflate(R.menu.album_fragment_popupmenu, popup.getMenu());
                //registering popup with OnMenuItemClickListener
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.play:
                                List<AudioModel> arrayList=MusicUtils.getSongsForAlbum(context,albumModelList.get(position).id);
                               ...
                               // Global.intent_method(context, SongPlayingActivity.class);
                                ...
                                break;
                            case R.id.play_next:
                                arrayList=MusicUtils.getSongsForAlbum(context,albumModelList.get(position).id);
...
//                                sessionManager.setSong_JsonList(song_arrays.toString());
                            ...
                            case R.id.add_to_playlist:
                                audioModelList=MusicUtils.getSongsForAlbum(context,albumModelList.get(position).id);
                            ...
                            case R.id.go_to_artist:
                                sessionManager.setArtistId(albumModelList.get(position).getArtistId());
...
//                                dayString = "Sunday";
                            ...
                            case R.id.share:
                                sessionManager.setAlbumId(albumModelList.get(position).getId());
                                List<AudioModel> audioModelList1 = MusicUtils.getSongsForAlbum(context ,sessionManager.getAlbumId());
