...
public class SearchSongsAdapter extends RecyclerView.Adapter<SearchSongsAdapter.MyViewHolder> {

    List<AudioModel> audioModelList;
    Context context;
    SessionManager sessionManager;
    public SearchSongsAdapter(Context context, List<AudioModel> audioModelList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.search_song_list_item, parent, false);
...
//        }
        ...
        holder.audio_authur.setText(audioModelList.get(position).getaArtist()+" . "+audioModelList.get(position).getaAlbum());
...
//        });
        ...
        holder.search_song_layout.setOnClickListener(new View.OnClickListener() {
            @Override
...
//        RelativeLayout no_audio_image;
        ...
        LinearLayout search_song_layout;
...
//            no_audio_image = (RelativeLayout) itemView.findViewById(R.id.no_audio_image);
            ...
            search_song_layout = (LinearLayout) itemView.findViewById(R.id.search_song_layout);
        }
    }
