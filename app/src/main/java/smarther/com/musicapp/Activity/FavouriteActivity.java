...
//    List<AudioModel> playing_audio_list=new ArrayList<>();
    public static FavouritesSongAdapter playlistItemAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playlist_song_recycler.setLayoutManager(new GridLayoutManager(FavouriteActivity.this, 1, LinearLayoutManager.VERTICAL, false));
        playlist_song_recycler.setHasFixedSize(true);
        playlist_song_recycler.setNestedScrollingEnabled(false);
        Realm.init(FavouriteActivity.this);
...
//        }
        ...
        else
        {
            ...
            // Global.intent_method(FavouriteActivity.this, SongPlayingActivity.class);
        }
        ...
        plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Global.intent_method(FavouriteActivity.this,PlaylistAddSearch.class);
                Intent intent=new Intent(FavouriteActivity.this,PlaylistAddSearch.class);
        ...
        play_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(BackgroundMusicService.bg_mediaPlayer!=null)
                {
                    ...
                    Intent serviceIntent = new Intent(FavouriteActivity.this, BackgroundMusicService.class);
                ...
                else
                {
                    play_button.setImageDrawable(getResources().getDrawable(R.drawable.ic_pause));
//                   Global.intent_method(FavouriteActivity.this, SongPlayingActivity.class);
                    Intent intent=new Intent(FavouriteActivity.this,SongPlayingActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        queue_music.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(FavouriteActivity.this,PlayingQueue.class);
        ...
        scan_3dot_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Context wrapper = new ContextThemeWrapper(FavouriteActivity.this, R.style.popupMenuStyle);
...
//                                sessionManager.setSong_JsonList(song_arrays.toString());
                            ...
                            case R.id.add_to_playlist:
                                ...
                                add_to_playlist_alert(FavouriteActivity.this);
                                playlistItemAdapter.notifyDataSetChanged();

//                                audioModelList = MusicUtils.getSongsForAlbum(FavouriteActivity.this, sessionManager.getAlbumId());
//                                add_to_playlist_alert(FavouriteActivity.this);
...
//
        ...
        folder_plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JsonArray song_arrays = gson_lists.toJsonTree(playing_audio_list).getAsJsonArray();
                sessionManager.setSong_JsonList(song_arrays.toString());
                Toast.makeText(FavouriteActivity.this,"Added "+size+" Tiles to the playing queue",Toast.LENGTH_SHORT).show();
            }
        });

        sessionManager=new SessionManager(FavouriteActivity.this);
        ...
        else
        {
            ...
            try {
                ...
                File f = new File(Global.getRealPathFromURI(FavouriteActivity.this,selectedImageUri));
...
//            mmr.setDataSource(FavouriteActivity.this,uri);
...
//        playlist_detail.setText(size);
        ...
        playlistItemAdapter=new FavouritesSongAdapter(FavouriteActivity.this,playlistAudioModel);
