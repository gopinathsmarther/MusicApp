...
public class SettingsLockscreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager=new SessionManager(SettingsLockscreenActivity.this);
        ...
        else
        {
            ...
            try {
                ...
                File f = new File(Global.getRealPathFromURI(SettingsLockscreenActivity.this,selectedImageUri));
