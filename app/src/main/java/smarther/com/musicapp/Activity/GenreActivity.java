...
import smarther.com.musicapp.Adapter.GenreSongsAdapter;
...
public class GenreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_genre);
            ...
            album_songs_recycler.setLayoutManager(new GridLayoutManager(GenreActivity.this, 1, LinearLayoutManager.VERTICAL, false));
            album_songs_recycler.setHasFixedSize(true);
            album_songs_recycler.setNestedScrollingEnabled(false);

            sessionManager=new SessionManager(GenreActivity.this);
            ...
            album_to_search.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Global.intent_method(GenreActivity.this, SearchActivity.class);
            ...
            else
            {
                ...
                try {
                    ...
                    File f = new File(Global.getRealPathFromURI(GenreActivity.this,selectedImageUri));
...
//            Drawable dr = new BitmapDrawable(sessionManager.getFileManagerTheme());
            ...
            GenresModel albumModel= MusicUtils.getGenre(GenreActivity.this,sessionManager.getGenreId());
            if(albumModel!=null)
            {
...
//                }
                album_name.setText(albumModel.getName());
                artist_name.setVisibility(View.GONE);
                songs_in_album.setText(albumModel.getSongCount()+" Songs");

            }

            GenreSongsAdapter songsAdapter=new GenreSongsAdapter(GenreActivity.this,MusicUtils.getSongsForGenre(GenreActivity.this,sessionManager.getGenreId()));
        ...
        album_more_option.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Context wrapper = new ContextThemeWrapper(GenreActivity.this, R.style.popupMenuStyle);
//                PopupMenu popup = new PopupMenu(wrapper, view);
                PopupMenu popup = new PopupMenu(wrapper, album_more_option);
                //Inflating the Popup using xml file
                popup.getMenuInflater().inflate(R.menu.genre_page_detail_title_popup, popup.getMenu());
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    @Override
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            case R.id.play_next:
                                List<AudioModel> arrayList =MusicUtils.getSongsForGenre(GenreActivity.this,sessionManager.getGenreId());
                            ...
                            case R.id.add_to_playing_queue:
                                arrayList = MusicUtils.getSongsForGenre(GenreActivity.this,sessionManager.getGenreId());
                            ...
                            case R.id.add_to_playlist:
                                audioModelList=MusicUtils.getSongsForGenre(GenreActivity.this,sessionManager.getGenreId());
                                add_to_playlist_alert(GenreActivity.this);
...
//            playlist_count.setText(""+playlistModelList.size());
    ...
    public void shuffle_all(){
        ...
        audioModelList = GenreSongsAdapter.audioModelList;
...
//                startService(new Intent(SongPlayingActivity.this, BackgroundMusicService.class));
            Intent stopserviceIntent = new Intent(GenreActivity.this, BackgroundMusicService.class);
            stopserviceIntent.setAction(Constants.ACTION.STOPFOREGROUND_ACTION);
            stopService(stopserviceIntent);
            Intent serviceIntent = new Intent(GenreActivity.this, BackgroundMusicService.class);
