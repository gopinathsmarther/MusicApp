...
import smarther.com.musicapp.Utils.MarkerView;
import smarther.com.musicapp.Utils.MusicUtils;
import smarther.com.musicapp.Utils.SamplePlayer;
import smarther.com.musicapp.Utils.SessionManager;
import smarther.com.musicapp.Utils.SongMetadataReader;
import smarther.com.musicapp.Utils.WaveformView;
...
public class RingtoneCutter extends AppCompatActivity  implements MarkerView.MarkerListener,
       WaveformView.WaveformListener{
    SessionManager sessionManager;
    LinearLayout editor_bg;
     ...
     */
    public static final String EDIT = "com.visan.action.EDIT";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save_tone = findViewById(R.id.save_tone);
        mPlayer = null;
        mIsPlaying = false;
        ...
        back=findViewById(R.id.back_rc);
...
//        mFilename = intent.getData().toString().replaceFirst("file://", "").replaceAll("%20", " ");
        ...
        System.out.println("mFilenamemFilename  " + mFilename);
...
//        save_tone.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                onSave();
//            }
...
//    }
    ...
    private void loadGui() {
        ...
        save_tone = findViewById(R.id.save_tone);
        save_tone.setOnClickListener(mSaveListener);

        editor_bg = (LinearLayout) findViewById(R.id.editor_bg);
        ...
        if (mSoundFile != null && !mWaveformView.hasSoundFile()) {
            ...
            mWaveformView.recomputeHeights(mDensity);
            mMaxPos = mWaveformView.maxPos();
            System.out.println("mMaxPosmMaxPos>>>>>>>>>>>>   "+mMaxPos);
        }
        ...
        {
            editor_bg.setBackgroundResource(Integer.parseInt(sessionManager.getSelectedTheme()));
        }
        else
        {
            Drawable bg;
            ...
            try {
                ...
                File f = new File(Global.getRealPathFromURI(RingtoneCutter.this,selectedImageUri));
...
//            Drawable dr = new BitmapDrawable(sessionManager.getFileManagerTheme());
    ...
    private void loadFromFile() {
        ...
        SongMetadataReader metadataReader = new SongMetadataReader(this, mFilename);mTitle = metadataReader.mTitle;mArtist = metadataReader.mArtist;
        mLoadingLastUpdateTime = getCurrentTime();
        mLoadingKeepGoing = true;
        mFinishActivity = false;
        mProgressDialog = new ProgressDialog(RingtoneCutter.this, R.style.MyTheme);
    ...
    private void recordAudio() {
        ...
        mFinishActivity = false;
        AlertDialog.Builder adBuilder = new AlertDialog.Builder(RingtoneCutter.this);
    ...
    private void finishOpeningSoundFile() {
        ...
        mMaxPos = mWaveformView.maxPos();
        System.out.println("mMaxPosmMaxPosmMaxPosmMaxPos  "+mMaxPos);
        mLastDisplayedStartPos = -1;
        mLastDisplayedEndPos = -1;
        ...
        if (mEndPos > mMaxPos)
            mEndPos = mMaxPos;
        System.out.println("mEndPosmEndPosmEndPosmEndPos  "+mEndPos);
        mCaption =
    ...
    private void enableDisableButtons() {
        if (mIsPlaying) {
            ...
            if(BackgroundMusicService.bg_mediaPlayer!=null) {
                ...
                System.out.println("aji BackroundPlayer is null");
            }
        } else {
    ...
    private void showFinalAlert(Exception e, CharSequence message) {
        ...
        new AlertDialog.Builder(RingtoneCutter.this, R.style.MyTheme)
                .setTitle(title)
                .setMessage(message)
                .setPositiveButton(
        ...
        mSaveSoundFileThread = new Thread() {
            public void run() {
                ...
                if (fallbackToWAV) {
                    ...
                    try {
                        ...
                        if (e.getMessage() != null && e.getMessage().equals("No space left on device"))
                        {
                            ...
                            System.out.println("aji save writing error 1");
                ...
                try {
                    ...
                    Runnable runnable = new Runnable() {
                        public void run() {
                            System.out.println("aji save writing error 2");
    ...
    private void afterSavingRingtone(CharSequence title,
        ...
        if (mNewFileKind == FileSaveDialog.FILE_KIND_NOTIFICATION) {
            new AlertDialog.Builder(RingtoneCutter.this)
        ...
        final Dialog dialoggg = new Dialog(this);
        dialoggg.setContentView(R.layout.after_save_action);
        dialoggg.setCancelable(true);
        dialoggg.show();
        dialoggg.getWindow().setBackgroundDrawable(new ColorDrawable(R.color.alertbg));

        Button button1 = (Button) dialoggg.findViewById(R.id.button_make_default);
        Button button2 = (Button) dialoggg.findViewById(R.id.button_choose_contact);
        Button button3 = (Button) dialoggg.findViewById(R.id.button_do_nothing);

        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                MusicUtils.initSetAsRingTone2(RingtoneCutter.this, newUri);
...
//        dlog.show();
    ...
    private void chooseContactForRingtone(Uri uri) {
        try {
            ...
            intent.setClassName(
                    this.getPackageName(),
                    "com.appsafari.ChooseContactActivity");
...
//        dlog.getWindow().setBackgroundDrawable(new ColorDrawable(R.color.black));
        dlog.show();
    }
